...
class AdminCreateProduct {
  ...
  factory AdminCreateProduct.fromJson(Map<String, dynamic> json) => AdminCreateProduct(
    ...
    options: (json["options"] as List?)?.map((e) => e).toList().cast<dynamic>(),
  ...
  Map<String, dynamic> toJson() => {
    ...
    if (options != null) "options": options!.map((e) => e).toList(),
...
class AdminCreateProductOption {
  ...
  /// The ranking of the option's values. The keys are the value names and the values are their respective ranks.
  final Map<String, dynamic>? ranks;
  /// Whether the option is exclusive to the product.
