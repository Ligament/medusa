...
/// The response for initiating an export inventory items workflow.
class AdminExportInventoryItemResponse {
  AdminExportInventoryItemResponse({
    this.transactionId,
  });

  /// The ID of the workflow execution's transaction. Use it to check the status of the export by sending a GET request to `/admin/workflows-executions/export-invento
  final String? transactionId;

  factory AdminExportInventoryItemResponse.fromJson(Map<String, dynamic> json) => AdminExportInventoryItemResponse(
...
class AdminInvite {
  ...
  final DateTime? updatedAt;
  /// The roles of the invited user.
  final List<AdminRbacRole>? rbacRoles;
  ...
  factory AdminInvite.fromJson(Map<String, dynamic> json) => AdminInvite(
    ...
    createdAt: json["created_at"] == null ? null : DateTime.parse(json["created_at"] as String),
    updatedAt: json["updated_at"] == null ? null : DateTime.parse(json["updated_at"] as String),
    rbacRoles: (json["rbac_roles"] as List?)?.map((e) => e == null ? null : AdminRbacRole.fromJson(e as Map<String, dynamic>)).toList().cast<AdminRbacRole>(),
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    if (createdAt != null) "created_at": createdAt!.toIso8601String(),
    if (updatedAt != null) "updated_at": updatedAt!.toIso8601String(),
    if (rbacRoles != null) "rbac_roles": rbacRoles!.map((e) => e.toJson()).toList(),
  };
}
...
/// The layout configuration's details.
class AdminLayoutConfiguration {
  ...
  final String? id;
  /// The layout configuration's zone.
  final String? zone;
  /// The ID of the user who created the layout configuration.
  final String? userId;
  /// Whether the layout configuration is a system default.
  final bool? isSystemDefault;
  /// The configuration's details.
  final Map<String, dynamic>? configuration;
  /// The date the layout configuration was created.
  final DateTime? createdAt;
  /// The date the layout configuration was last updated.
  final DateTime? updatedAt;

  factory AdminLayoutConfiguration.fromJson(Map<String, dynamic> json) => AdminLayoutConfiguration(
    id: json["id"] as String?,
